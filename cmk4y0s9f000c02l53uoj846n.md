...
Multiple stages of the [**Software Development Lifecycle**](https://keploy.io/blog/community/software-development-phases) (SDLC) have baseline tests to ensure controlled evolution of software builds and artifacts.

* **Requirement Phase:** Approved specs establish baselines for requirements to avoid gaps in tracking or changes to the scope without control.
    
* **Design & Development Phase:** Once sufficient stability of a build is achieved, the development team will determine which config and functional baselines would best be referenced when supporting future development iterations.
    
* **Testing Phase:** Performance, regression, and system behaviour are tested against a defined baseline, enabling identification of deviating behaviour, including degradation and/or defects.
    
* **Release & Maintenance Phase:** Each production release creates a new baseline for the development team to perform impact analysis and develop a structured process for applying future changes.
    

By using these baseline checkpoints at each point throughout the SDLC, teams can ensure version control, change governance, and measurable quality continuities throughout the product lifecycle.
